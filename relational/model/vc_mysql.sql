...
CREATE INDEX ix_Messages_CreatedAt ON votecube.messages (created_at Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX index_user_account_id5 -----------------------
CREATE INDEX index_user_account_id5 ON votecube.messages (user_account_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX index_parent_message_id ----------------------
CREATE INDEX index_parent_message_id ON votecube.messages (parent_message_id) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_PollsMessages_MessageId ON votecube.polls_messages (message_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsMessages_PollId ----------------------
CREATE INDEX fk_PollsMessages_PollId ON votecube.polls_messages (poll_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_PollsMessages_PollMessageId ---------------
CREATE INDEX pk_PollsMessages_PollMessageId ON votecube.polls_messages (poll_message_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_MessagesLinks_MessageLinkId ON votecube.messages_links (message_link_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_MessagesLinks_LinkId ----------------------
CREATE INDEX fk_MessagesLinks_LinkId ON votecube.   messages_links (link_id) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_Labels_UserAccountId ON votecube.labels (user_account_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_Labels_LabelId ----------------------------
CREATE INDEX pk_Labels_LabelId ON votecube.labels (label_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Labels_Name -------------------------------
CREATE INDEX ak_Labels_Name ON votecube.labels (name Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_Themes_ThemeId ON votecube.themes (theme_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_PollsLabels_PollId ON votecube.polls_labels (poll_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsLabels_LabelId -----------------------
CREATE INDEX fk_PollsLabels_LabelId ON votecube.polls_labels (label_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsLabels_UserAccountId -----------------
CREATE INDEX fk_PollsLabels_UserAccountId ON votecube.polls_labels (user_account_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_PollsLabels_PollLabelId -------------------
CREATE INDEX pk_PollsLabels_PollLabelId ON votecube.polls_labels (poll_label_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_PollsLinks_PollLinkId ON votecube.polls_links (poll_link_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsLinks_PollId -------------------------
CREATE INDEX fk_PollsLinks_PollId ON votecube.polls_links (poll_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsLinks_LinkId -------------------------
CREATE INDEX fk_PollsLinks_LinkId ON votecube.polls_links (link_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsLinks_UserAccountId ------------------
CREATE INDEX fk_PollsLinks_UserAccountId ON votecube.polls_links (user_account_id Asc) USING btree;
-- -------------------------------------------------------------
...
(
  ...
  poll_group_description Character Varying(765) NOT NULL,
  user_account_id        Bigint                   NOT NULL,
  theme_id               Bigint                   NOT NULL,
  created_at             Timestamp NOT NULL,
...
CREATE INDEX fk_PollsGroups_UserAccountId ON votecube.polls_groups (user_account_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsGroups_ThemeId -----------------------
CREATE INDEX fk_PollsGroups_ThemeId ON votecube.polls_groups (theme_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_PollsGroups_PollGroupId -------------------
CREATE UNIQUE INDEX pk_PollsGroups_PollGroupId ON votecube.polls_groups (poll_group_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_PollsPollsGroups_PollGroupid ON votecube.polls_polls_groups (poll_group_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsPollsGroups_UserAccountId ------------
CREATE INDEX fk_PollsPollsGroups_UserAccountId ON votecube.polls_polls_groups (user_account_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_PollsPollsGroups_PollPollGroupId ----------
CREATE INDEX pk_PollsPollsGroups_PollPollGroupId ON votecube.polls_polls_groups (poll_poll_group_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsPollsGroups_Pollid -------------------
CREATE INDEX fk_PollsPollsGroups_Pollid ON votecube.polls_polls_groups (poll_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_PollsGroupsLinks_PollGroupId ON votecube.polls_groups_links (poll_group_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsGroupsLinks_LinkId -------------------
CREATE INDEX fk_PollsGroupsLinks_LinkId ON votecube.polls_groups_links (link_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsGroupsLinks_UserAccountId ------------
CREATE INDEX fk_PollsGroupsLinks_UserAccountId ON votecube.polls_groups_links (user_account_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_PollsGroupsLinks_PollGroupLinkId ----------
CREATE INDEX pk_PollsGroupsLinks_PollGroupLinkId ON votecube.polls_groups_links (poll_group_link_id Asc) USING btree;
-- -------------------------------------------------------------
...
(
  ...
  user_account_id    Bigint                   NOT NULL,
  factor_name        Character Varying(40)    NOT NULL,
  factor_description Character Varying(10000), -- NOT NULL,
  -- color_id Bigint NOT NULL,
  created_at         Timestamp NOT NULL,
  PRIMARY KEY (factor_id),
  CONSTRAINT u_Factors_FactorId UNIQUE (factor_id)
);
;
-- -------------------------------------------------------------

-- CREATE INDEX fk_Factors_ParentFactorId --------------
CREATE INDEX fk_Factors_ParentFactorId ON votecube.factors (parent_factor_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_Factors_FactorId --------------------
CREATE INDEX pk_Factors_FactorId ON votecube.factors (factor_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_Factors_UserAccountId ------------------
CREATE INDEX fk_Factors_UserAccountId ON votecube.factors (user_account_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ix_Factors_FactorNameId ----------------
CREATE INDEX ix_Factors_FactorNameId ON votecube.factors (factor_name Asc) USING btree;
-- -------------------------------------------------------------


-- CREATE TABLE factors_links -----------------------------
CREATE TABLE votecube.factors_links
(
  factors_link_id Bigint                   NOT NULL,
  factors_id      Bigint                   NOT NULL,
  links_id        Bigint                   NOT NULL,
  user_account_id Bigint                   NOT NULL,
  created_at      Timestamp NOT NULL,
  PRIMARY KEY (factors_link_id),
  CONSTRAINT u_FactorsLinks_FactorLinkId UNIQUE (factors_link_id)
);
;
-- -------------------------------------------------------------

-- CREATE INDEX fk_FactorsLinks_FactorId ---------------
CREATE INDEX fk_FactorsLinks_FactorId ON votecube.factors_links (factors_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_FactorsLinks_LinkId --------------------
CREATE INDEX fk_FactorsLinks_LinkId ON votecube.factors_links (links_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_FactorsLinks_UserAccountId -------------
CREATE INDEX fk_FactorsLinks_UserAccountId ON votecube.factors_links (user_account_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_FactorsLinks_FactorLinkId -----------
CREATE INDEX pk_FactorsLinks_FactorLinkId ON votecube.factors_links (factors_link_id Asc) USING btree;
-- -------------------------------------------------------------
...
(
  ...
  position_description Character Varying(128)   NOT NULL,
  user_account_id      Bigint                   NOT NULL,
  design_pattern_id    Bigint, -- NOT NULL,
  emoji_id             Bigint, -- NOT NULL,
  created_at           Timestamp NOT NULL,
  PRIMARY KEY (position_id),
  CONSTRAINT u_Positions_PositionId UNIQUE (position_id)
);
;
-- -------------------------------------------------------------

-- CREATE INDEX fk_Positions_ParentPositionId --------------
CREATE INDEX fk_Positions_ParentPositionId ON votecube.positions (parent_position_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ix_Positions_PositionDescription -----------
CREATE INDEX ix_Positions_PositionDescription ON votecube.positions (position_description) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_Positions_UserAccountId ------------------
CREATE INDEX fk_Positions_UserAccountId ON votecube.positions (user_account_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_Positions_PositionId --------------------
CREATE INDEX pk_Positions_PositionId ON votecube.positions (position_id Asc) USING btree;
-- -------------------------------------------------------------
...
(
  factor_position_id Bigint                   NOT NULL,
  factor_id          Bigint                   NOT NULL,
  position_id        Bigint                   NOT NULL,
  user_account_id    Bigint                   NOT NULL,
  created_at         Timestamp NOT NULL,
  PRIMARY KEY (factor_position_id),
  CONSTRAINT u_FactorPositions_FactorPositionId UNIQUE (factor_position_id)
);
;
-- -------------------------------------------------------------

-- CREATE INDEX fk_FactorPositions_FactorId -----------
CREATE INDEX fk_FactorPositions_FactorId ON votecube.factor_positions (factor_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_FactorPositions_PositionId -----------
CREATE INDEX fk_FactorPositions_PositionId ON votecube.factor_positions (position_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_FactorPositions_FactorPositionId --
CREATE INDEX pk_FactorPositions_FactorPositionId ON votecube.factor_positions (factor_position_id Asc) USING btree;
-- -------------------------------------------------------------


-- CREATE TABLE polls_factors_positions ------------------
CREATE TABLE votecube.polls_factors_positions
(
  poll_factor_position_id Bigint               NOT NULL,
  factor_position_id      Bigint               NOT NULL,
  poll_id                 Bigint               NOT NULL,
  factor_coordinate_axis  Character Varying(1) NOT NULL,
  position_orientation    Boolean              NOT NULL,
  color_id                Bigint               NOT NULL,
  design_pattern_id       Bigint, -- NOT NULL,
  emoji_id                Bigint, -- NOT NULL,
  PRIMARY KEY (poll_factor_position_id),
  CONSTRAINT u_PollsFactorsPositions_PollFactorPositionId UNIQUE (poll_factor_position_id),
  CONSTRAINT ck_PollsFactorsPositions_FactorCoordinateAxis CHECK (factor_coordinate_axis IN ('x', 'y', 'z'))
);
;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsFactorsPositions_FactorPositionId
CREATE INDEX fk_PollsFactorsPositions_FactorPositionId ON votecube.polls_factors_positions (factor_position_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsFactorsPositions_PollId ----------
CREATE INDEX fk_PollsFactorsPositions_PollId ON votecube.polls_factors_positions (poll_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_PollsFactorsPositions_PollFactorPositionId
CREATE INDEX pk_PollsFactorsPositions_PollFactorPositionId ON votecube.polls_factors_positions (poll_factor_position_id Asc) USING btree;
-- -------------------------------------------------------------
...
(
  ...
  user_account_id           Bigint                   NOT NULL,
  poll_id                   Bigint                   NOT NULL,
  x_poll_factor_position_id Bigint                   NOT NULL,
  y_poll_factor_position_id Bigint                   NOT NULL,
  z_poll_factor_position_id Bigint                   NOT NULL,
...
CREATE INDEX fk_Votes_UserAccountId ON votecube.vote (user_account_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_Votes_PollId ------------------------------
CREATE INDEX fk_Votes_PollId ON votecube.vote (poll_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_Votes_VoteId ------------------------------
CREATE INDEX pk_Votes_VoteId ON votecube.vote (vote_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_Polls_UserAccountId ON votecube.polls (user_account_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_Polls_PollThemeId -------------------------
CREATE INDEX fk_Polls_PollThemeId ON votecube.polls (theme_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Polls_PollTitle ---------------------------
CREATE INDEX ak_Polls_PollTitle ON votecube.polls (poll_title Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ix_Polls_StartDate ---------------------------
CREATE INDEX ix_Polls_StartDate ON votecube.polls (start_date Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ix_Polls_EndDate -----------------------------
CREATE INDEX ix_Polls_EndDate ON votecube.polls (end_date Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_Polls_ParentPollId ------------------------
CREATE INDEX fk_Polls_ParentPollId ON votecube.polls (parent_poll_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_Polls_PollId ------------------------------
CREATE INDEX pk_Polls_PollId ON votecube.polls (poll_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_Colors_ColorId ON votecube.colors (color_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Colors_RgbHexValue ------------------------
CREATE INDEX ak_Colors_RgbHexValue ON votecube.colors (rgb_hex_value Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_DesignPatterns_DesignPatternId ON votecube.design_patterns (design_pattern_id ASC) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_DesignPatterns_DesignPatternName ----------
CREATE INDEX ak_DesignPatterns_DesignPatternName ON votecube.design_patterns (design_pattern_name ASC) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_Emoji_EmojiId ON votecube.emoji (emoji_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Emoji_CssClass ----------------------------
CREATE INDEX ak_Emoji_CssClass ON votecube.emoji (css_class Asc) USING btree;
-- -------------------------------------------------------------
...
(
  link_id         Bigint                   NOT NULL,
  link_server     Character Varying(128)   NOT NULL,
  link_addres     Character Varying(637)  NOT NULL,
  user_account_id Bigint                   NOT NULL,
  created_at      Timestamp NOT NULL,
  PRIMARY KEY (link_id),
...
CREATE INDEX ak_Links_LinkServer ON votecube.links (link_server) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_Links_UserAccountID -----------------------
CREATE INDEX fk_Links_UserAccountID ON votecube.links (user_account_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_Links_LinkId ------------------------------
CREATE INDEX pk_Links_LinkId ON votecube.links (link_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_PollsContinent_PollContinentId ON votecube.polls_continent (poll_continent_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsContinent_PollId ---------------------
CREATE INDEX fk_PollsContinent_PollId ON votecube.polls_continent (poll_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsContinent_ContinentId ----------------
CREATE INDEX fk_PollsContinent_ContinentId ON votecube.polls_continent (continent_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_PollsCountry_PollCountryId ON votecube.polls_country (poll_country_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsCountry_PollId -----------------------
CREATE INDEX fk_PollsCountry_PollId ON votecube.polls_country (poll_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsCountry_CountryId --------------------
CREATE INDEX fk_PollsCountry_CountryId ON votecube.polls_country (country_id) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_PollsState_PollStateId ON votecube.polls_state (poll_state_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsState_StateId ------------------------
CREATE INDEX fk_PollsState_StateId ON votecube.polls_state (state_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsState_PollId -------------------------
CREATE INDEX fk_PollsState_PollId ON votecube.polls_state (poll_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_PollsCounty_PollCountyId ON votecube.polls_county (poll_county_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsCounty_PollId ------------------------
CREATE INDEX fk_PollsCounty_PollId ON votecube.polls_county (poll_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsCounty_CountyId ----------------------
CREATE INDEX fk_PollsCounty_CountyId ON votecube.polls_county (county_id) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_PollsTown_PollTownId ON votecube.polls_town (poll_town_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsTown_PollId --------------------------
CREATE INDEX fk_PollsTown_PollId ON votecube.polls_town (poll_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_PollsTown_TownId --------------------------
CREATE INDEX fk_PollsTown_TownId ON votecube.polls_town (town_id) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_PrefixLastName_PrefixLastNameId ON votecube.prefix_last_name (prefix_last_name_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_PrefixLastName_PrefixLastName -------------
CREATE INDEX ak_PrefixLastName_PrefixLastName ON votecube.prefix_last_name (prefix_last_name Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_NameAfterLastName_NameAfterLastNameId ON votecube.name_after_last_name (name_after_last_name_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_NameAfterLastName_NameAfterLastName -------
CREATE INDEX ak_NameAfterLastName_NameAfterLastName ON votecube.name_after_last_name (name_after_last_name Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_Suffix_SuffixId ON votecube.suffix (suffix_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Suffix_SuffixName -------------------------
CREATE INDEX ak_Suffix_SuffixName ON votecube.suffix (suffix_name Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_UserAccountSuffix_SuffixId ON votecube.user_account_suffix (suffix_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_UserAccountSuffix_UserAccountId -----------
CREATE INDEX fk_UserAccountSuffix_UserAccountId ON votecube.user_account_suffix (user_account_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_UserAccountSuffix_UserAccountSuffixId -----
CREATE INDEX pk_UserAccountSuffix_UserAccountSuffixId ON votecube.user_account_suffix (user_account_suffix_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX index_ethnic_group_id1 ON votecube.ethnic_group (ethnic_group_id) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_EthnicGroupCountry_EthnicGroupId ON votecube.ethnic_group_country (ethnic_group_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_EthnicGroupCountry_CountryId --------------
CREATE INDEX fk_EthnicGroupCountry_CountryId ON votecube.ethnic_group_country (country_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_EthnicGroupCountry_EthnicGroupCountryId ---
CREATE INDEX pk_EthnicGroupCountry_EthnicGroupCountryId ON votecube.ethnic_group_country (ethnic_group_country_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_EthnicSubgroup_EthnicGroupId ON votecube.ethnic_subgroup (ethnic_group_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ix_EthnicSubgroup_EthnicSubgroupCode ---------
CREATE INDEX ix_EthnicSubgroup_EthnicSubgroupCode ON votecube.ethnic_subgroup (ethnic_subgroup_code) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX index_ethnic_subgroup_name -------------------
CREATE INDEX index_ethnic_subgroup_name ON votecube.ethnic_subgroup (ethnic_subgroup_name) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_EthnicSubgroup_EthnicSubgroupId -----------
CREATE INDEX pk_EthnicSubgroup_EthnicSubgroupId ON votecube.ethnic_subgroup (ethnic_subgroup_id) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_UserAccountEthnicity_UserAccountId ON votecube.user_account_ethnicity (user_account_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_UserAccountEthnicity_EthnicSubgroupId -----
CREATE INDEX fk_UserAccountEthnicity_EthnicSubgroupId ON votecube.user_account_ethnicity (ethnic_subgroup_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_UserAccountEthnicity_UserAccountEthnicityId
CREATE INDEX pk_UserAccountEthnicity_UserAccountEthnicityId ON votecube.user_account_ethnicity (user_account_ethnicity_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_UserAccount_UserAccountId ON votecube.user_account (user_account_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_UserAccount_UserName ----------------------
CREATE INDEX ak_UserAccount_UserName ON votecube.user_account (user_name Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ix_UserAccount_LastName ----------------------
CREATE INDEX ix_UserAccount_LastName ON votecube.user_account (last_name Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_Title_TitleId ON votecube.title (title_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Title_TitleName ---------------------------
CREATE INDEX ak_Title_TitleName ON votecube.title (title_name Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_UserPersonalInfoTitle_TitleId ON votecube.user_personal_info_title (title_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_UserPersonalInfoTitle_UserPersonalInfoTitleId
CREATE INDEX pk_UserPersonalInfoTitle_UserPersonalInfoTitleId ON votecube.user_personal_info_title (user_personal_info_title_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_UserPersonalInfoTitle_UserPersonalInfoId --
CREATE INDEX fk_UserPersonalInfoTitle_UserPersonalInfoId ON votecube.user_personal_info_title (user_personal_info_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_TitleAfterLastName_TitleAfterLastNameId ON votecube.title_after_last_name (title_after_last_name_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_TitleAfterLastName_TitleAfterLastName -----
CREATE INDEX ak_TitleAfterLastName_TitleAfterLastName ON votecube.title_after_last_name (title_after_last_name Asc) USING btree;
-- -------------------------------------------------------------
...
(
  ...
  CONSTRAINT u_UserPersonalInfoTitleAfterLastName_Id UNIQUE (user_personal_info_title_after_last_name_id)
);
;
-- -------------------------------------------------------------

-- CREATE INDEX pk_UserPersonalInfoTitleAfterLastName_UserPersonalInfoTitleAfterLastNameId
CREATE INDEX pk_UserPersonalInfoTitleAfterLastName_Id ON votecube.user_personal_info_title_after_last_name (title_after_last_name_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_UserPersonalInfoTitleAfterLastName_UserPersonalInfoId
CREATE INDEX fk_UserPersonalInfoTitleAfterLastName_UserPersonalInfoId ON votecube.user_personal_info_title_after_last_name (user_personal_info_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_UserPersonalInfoTitleAfterLastName_TitleAfterLastNameId
CREATE INDEX fk_UserPersonalInfoTitleAfterLastName_TitleAfterLastNameId ON votecube.user_personal_info_title_after_last_name (title_after_last_name_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_EmailDomain_EmailDomainId ON votecube.email_domain (email_domain_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_EmailDomain_EmailDomainName ---------------
CREATE INDEX ak_EmailDomain_EmailDomainName ON votecube.email_domain (email_domain_name Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_EmailAddress_EmailDomainId ON votecube.email_address (email_domain_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_EmailAddress_UserAccountId ----------------
CREATE INDEX fk_EmailAddress_UserAccountId ON votecube.email_address (user_account_id) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_PersonType_PersonTypeId ON votecube.person_type (person_type_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_PersonType_PersonTypeName -----------------
CREATE INDEX ak_PersonType_PersonTypeName ON votecube.person_type (person_type_name Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_Honors_HonorId ON votecube.honors (honor_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Honors_HonorName --------------------------
CREATE INDEX ak_Honors_HonorName ON votecube.honors (honor_name Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_UserPersonalInfoHonors_HonorsId ON votecube.user_personal_info_honors (honor_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_UserPersonalInfoHonors_UserPersonalInfoHonorId
CREATE INDEX pk_UserPersonalInfoHonors_UserPersonalInfoHonorId ON votecube.user_personal_info_honors (user_personal_info_honor_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_UserPersonalInfoHonors_UserPersonalInfoId -
CREATE INDEX fk_UserPersonalInfoHonors_UserPersonalInfoId ON votecube.user_personal_info_honors (user_personal_info_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_Continent_ContinentId ON votecube.continent (continent_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Continent_ContinentCode -------------------
CREATE INDEX ak_Continent_ContinentCode ON votecube.continent (continent_code Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Continent_ContinentName -------------------
CREATE INDEX ak_Continent_ContinentName ON votecube.continent (continent_name Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_Country_CountryId ON votecube.country (country_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Country_CountryCode -----------------------
CREATE INDEX ak_Country_CountryCode ON votecube.country (country_code Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Country_CountryName -----------------------
CREATE INDEX ak_Country_CountryName ON votecube.country (country_name Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_Country_ContinentId -----------------------
CREATE INDEX fk_Country_ContinentId ON votecube.country (continent_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_State_CountryId ON votecube.state (country_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_State_StateId -----------------------------
CREATE INDEX pk_State_StateId ON votecube.state (state_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_State_StateCode ---------------------------
CREATE INDEX ak_State_StateCode ON votecube.state (state_code Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_State_StateName ---------------------------
CREATE INDEX ak_State_StateName ON votecube.state (state_name Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_County_StateId ON votecube.county (state_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_County_CountyId ---------------------------
CREATE INDEX pk_County_CountyId ON votecube.county (county_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_County_CountyCode -------------------------
CREATE INDEX ak_County_CountyCode ON votecube.county (county_code Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_County_CountyName -------------------------
CREATE INDEX ak_County_CountyName ON votecube.county (county_name Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_Town_TownId ON votecube.town (town_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Town_TownCode -----------------------------
CREATE INDEX ak_Town_TownCode ON votecube.town (town_code Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Town_TownName -----------------------------
CREATE INDEX ak_Town_TownName ON votecube.town (town_name Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_Town_CountyId -----------------------------
-- CREATE INDEX fk_Town_CountyId ON votecube.town( county_id Asc) USING btree;
-- -------------------------------------------------------------
-- -------------------------------------------------------------

-- CREATE INDEX fk_Town_StateId -----------------------------
CREATE INDEX fk_Town_StateId ON votecube.town (state_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_Suberb_TownId ON votecube.suburb (town_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_Suberb_SuberbId ---------------------------
CREATE INDEX pk_Suberb_SuberbId ON votecube.suburb (suburb_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Suberb_SuberbCode -------------------------
CREATE INDEX ak_Suberb_SuberbCode ON votecube.suburb (suburb_code Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Suberb_SuberbName -------------------------
CREATE INDEX ak_Suberb_SuberbName ON votecube.suburb (suburb_name Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_StreetName_StreetNameId ON votecube.street_name (street_name_id ASC) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_StreetName_StreetName ---------------------
CREATE INDEX ak_StreetName_StreetName ON votecube.street_name (street_name ASC) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_StreetType_StreetTypeId ON votecube.street_type (street_type_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_StreetType_StreetType ---------------------
CREATE INDEX ak_StreetType_StreetType ON votecube.street_type (street_type Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_Street_StreetNameId ON votecube.street (street_name_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_Street_StreetTypeId -----------------------
CREATE INDEX fk_Street_StreetTypeId ON votecube.street (street_type_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_Street_SuburbId ---------------------------
CREATE INDEX fk_Street_SuburbId ON votecube.street (suburb_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_Street_StreetId ---------------------------
CREATE INDEX pk_Street_StreetId ON votecube.street (street_id Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_Address_StreetId ON votecube.address (street_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_Address_AddressId -------------------------
CREATE INDEX pk_Address_AddressId ON votecube.address (address_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_Address_PostCode --------------------------
CREATE INDEX fk_Address_PostCode ON votecube.address (post_code Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX pk_Timezone_TimezoneId ON votecube.timezone (timezone_id Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Timezone_TimezoneName ---------------------
CREATE INDEX ak_Timezone_TimezoneName ON votecube.timezone (timezone_name Asc) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX ak_Timezone_TimezoneOffset -------------------
CREATE INDEX ak_Timezone_TimezoneOffset ON votecube.timezone (timezone_offset Asc) USING btree;
-- -------------------------------------------------------------
...
CREATE INDEX fk_UserPersonalInfo_UserAccountId ON votecube.user_personal_info (user_account_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX fk_UserPersonalInfo_EmailAddressId -----------
CREATE INDEX fk_UserPersonalInfo_EmailAddressId ON votecube.user_personal_info (email_address_id) USING btree;
-- -------------------------------------------------------------

-- CREATE INDEX pk_UserPersonalInfo_UserPersonalInfoId -------
CREATE INDEX pk_UserPersonalInfo_UserPersonalInfoId ON votecube.user_personal_info (user_personal_info_id Asc) USING btree;
-- -------------------------------------------------------------
...
-- CREATE self LINK fk_Factors_Factors_ParentFactorId ----
ALTER TABLE votecube.factors
  ADD CONSTRAINT fk_Factors_Factors_ParentFactorId FOREIGN KEY (parent_factor_id)
    REFERENCES votecube.factors (factor_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------


-- CREATE LINK fk_Factors_UserAccount_UserAccountId -------
ALTER TABLE votecube.factors
  ADD CONSTRAINT fk_Factors_UserAccount_UserAccountId FOREIGN KEY (user_account_id)
    REFERENCES votecube.user_account (user_account_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------
...
-- CREATE LINK fk_Factors_Colors_ColorId ------------------
/*
ALTER TABLE votecube.factors
	ADD CONSTRAINT fk_Factors_Colors_ColorId FOREIGN KEY ( color_id )
...
-- CREATE LINK fk_FactorsLinks_Factors_FactorId -----
ALTER TABLE votecube.factors_links
  ADD CONSTRAINT fk_FactorsLinks_Factors_FactorId FOREIGN KEY (factors_id)
    REFERENCES votecube.factors (factor_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------
...
-- CREATE LINK fk_FactorsLinks_UserAccount_UserAccountId --
ALTER TABLE votecube.factors_links
  ADD CONSTRAINT fk_FactorsLinks_UserAccount_UserAccountId FOREIGN KEY (user_account_id)
    REFERENCES votecube.user_account (user_account_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------
...
-- CREATE LINK fk_FactorsLinks_Links_LinkId ---------------
ALTER TABLE votecube.factors_links
  ADD CONSTRAINT fk_FactorsLinks_Links_LinkId FOREIGN KEY (links_id)
    REFERENCES votecube.links (link_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------
...
/*
-- CREATE self LINK fk_Positions_Positions_ParentPositionId ----
ALTER TABLE votecube.positions
	ADD CONSTRAINT fk_Positions_Positions_ParentPositionId FOREIGN KEY ( parent_position_id )
	REFERENCES votecube.positions ( parent_position_id ) MATCH FULL
	ON DELETE Cascade
	ON UPDATE Cascade;
-- -------------------------------------------------------------
*/
...
-- CREATE LINK fk_Positions_UserAccount_UserAccountId -------
ALTER TABLE votecube.positions
  ADD CONSTRAINT fk_Positions_UserAccount_UserAccountId FOREIGN KEY (user_account_id)
    REFERENCES votecube.user_account (user_account_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------
...
-- CREATE LINK fk_Positions_DesignPatterns_DesignPatternId --
ALTER TABLE votecube.positions
  ADD CONSTRAINT fk_Positions_DesignPatterns_DesignPatternId FOREIGN KEY (design_pattern_id)
...
-- CREATE LINK fk_Positions_Emoji_EmojiId -------------------
ALTER TABLE votecube.positions
  ADD CONSTRAINT fk_Positions_Emoji_EmojiId FOREIGN KEY (emoji_id)
...
-- CREATE LINK fk_FactorPositions_Factors_FactorId -
ALTER TABLE votecube.factor_positions
  ADD CONSTRAINT fk_FactorPositions_Factors_FactorId FOREIGN KEY (factor_id)
    REFERENCES votecube.factors (factor_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------
...
-- CREATE LINK fk_FactorPositions_Positions_PositionId -
ALTER TABLE votecube.factor_positions
  ADD CONSTRAINT fk_FactorPositions_Positions_PositionId FOREIGN KEY (position_id)
    REFERENCES votecube.positions (position_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------


-- CREATE LINK fk_PollsFactorsPositions_FactorsPositions_FactorPositionId
ALTER TABLE votecube.polls_factors_positions
  ADD CONSTRAINT fk_PollsFactorsPositions_FactorsPositions_FactorPositionId FOREIGN KEY (factor_position_id)
    REFERENCES votecube.factor_positions (factor_position_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------


-- CREATE LINK fk_PollsFactorsPositions_Polls_PollId -----
ALTER TABLE votecube.polls_factors_positions
  ADD CONSTRAINT fk_PollsFactorsPositions_Polls_PollId FOREIGN KEY (poll_id)
...
-- CREATE LINK fk_PollFactorsPositions_Colorss_ColorId ---
ALTER TABLE votecube.polls_factors_positions
  ADD CONSTRAINT fk_PollFactorsPositions_Colorss_ColorId FOREIGN KEY (color_id)
    REFERENCES votecube.colors (color_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------
...
-- CREATE LINK fk_PollFactorsPositions_DesignPatterns_DesignPatternId
ALTER TABLE votecube.polls_factors_positions
  ADD CONSTRAINT fk_PollFactorsPositions_DesignPatterns_DesignPatternId FOREIGN KEY (design_pattern_id)
    REFERENCES votecube.design_patterns (design_pattern_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------
...
-- CREATE LINK fk_PollFactorsPositions_Emoji_EmojiId -----
ALTER TABLE votecube.polls_factors_positions
  ADD CONSTRAINT fk_PollFactorsPositions_Emoji_EmojiId FOREIGN KEY (emoji_id)
    REFERENCES votecube.emoji (emoji_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------
...
-- CREATE LINK fk_Votes_PollsFactorsPositions_XpollPositionFactorId
ALTER TABLE votecube.vote
  ADD CONSTRAINT fk_Votes_PollsFactorsPositions_XpollPositionFactorId FOREIGN KEY (x_poll_factor_position_id)
    REFERENCES votecube.polls_factors_positions (poll_factor_position_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------


-- CREATE LINK fk_Votes_PollsFactorsPositions_YpollPositionFactorId
ALTER TABLE votecube.vote
  ADD CONSTRAINT fk_Votes_PollsFactorsPositions_YpollPositionFactorId FOREIGN KEY (y_poll_factor_position_id)
    REFERENCES votecube.polls_factors_positions (poll_factor_position_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------
...
-- CREATE LINK fk_Votes_PollsFactorsPositions_ZpollPositionFactorId
ALTER TABLE votecube.vote
  ADD CONSTRAINT fk_Votes_PollsFactorsPositions_ZpollPositionFactorId FOREIGN KEY (z_poll_factor_position_id)
    REFERENCES votecube.polls_factors_positions (poll_factor_position_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------
...
ALTER TABLE votecube.user_personal_info_title_after_last_name
  ADD CONSTRAINT fk_UserPersonalInfoTitleAfterLastName_TitleAfterLastName_Id FOREIGN KEY (title_after_last_name_id)
...
ALTER TABLE votecube.user_personal_info_title_after_last_name
  ADD CONSTRAINT fk_UserPersonalInfoTitleAfterLastName_UserPersonalInfo_Id FOREIGN KEY (user_personal_info_id)
    REFERENCES votecube.user_personal_info (user_personal_info_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------
...
-- CREATE LINK fk_Town_State_StateId -----------------------
ALTER TABLE votecube.town
  ADD CONSTRAINT fk_Town_State_StateId FOREIGN KEY (state_id)
    REFERENCES votecube.state (state_id) MATCH FULL
    ON DELETE Cascade
    ON UPDATE Cascade;
-- -------------------------------------------------------------
...
--  sequence votecube.position_id;


CREATE TABLE votecube.sequences
(
    SEQUENCE_NAME VARCHAR(32) NOT NULL UNIQUE,
    CURRENT_VALUE BIGINT      NOT NULL
);

DROP PROCEDURE IF EXISTS votecube.CreateSequence;
DELIMITER :)
CREATE PROCEDURE votecube.CreateSequence( sequenceName VARCHAR(32), sequenceValue BIGINT )
BEGIN
    IF NOT EXISTS ( SELECT * FROM votecube.sequences WHERE (SEQUENCE_NAME = sequenceName) ) THEN
        INSERT INTO votecube.sequences (SEQUENCE_NAME, CURRENT_VALUE)
        VALUES (sequenceName, sequenceValue);
    END IF;
END :)
DELIMITER ;
...
DROP FUNCTION IF EXISTS votecube.GetSequenceVal;
DELIMITER :)
CREATE FUNCTION votecube.GetSequenceVal( sequenceName VARCHAR(32), incrementBy INTEGER )
    RETURNS BIGINT  -- incrementBy can be negative
BEGIN
    DECLARE sequenceValue BIGINT;

    SELECT CURRENT_VALUE FROM votecube.sequences
    WHERE  ( SEQUENCE_NAME = sequenceName )
    INTO   @sequenceValue;

    IF ( incrementBy <> 0 ) THEN
        SET @sequenceValue = @sequenceValue + incrementBy;

        UPDATE votecube.sequences SET CURRENT_VALUE = @sequenceValue
        WHERE  ( SEQUENCE_NAME = sequenceName );
    END IF;
...
CALL votecube.CreateSequence( 'position_id', 0 );
CALL votecube.CreateSequence( 'factor_id', 0 );
CALL votecube.CreateSequence( 'poll_id', 0 );
...
UPDATE votecube.sequences s
SET s.CURRENT_VALUE = s.CURRENT_VALUE + 100
WHERE s.SEQUENCE_NAME = 'poll_id';

-- CREATE SEQUENCE votecube.position_id START 100 INCREMENT 100;
-- CREATE SEQUENCE votecube.factor_id START 100 INCREMENT 100;
-- CREATE SEQUENCE votecube.poll_id START 100 INCREMENT 100;
-- CREATE SEQUENCE votecube.factor_position_id START 100 INCREMENT 100;
-- CREATE SEQUENCE votecube.poll_factor_position_id START 100 INCREMENT 100;

-- select nextval('votecube.position_id');

-- select currval('votecube.position_id');


/*
insert INTO votecube.user_account
values (1, --user_account_id Bigint NOT NULL,
        'test_user', --user_name Character Varying( 64 ) NOT NULL,
        'Test', --first_name Character Varying( 256 ),
        'VC', --middle_name_or_initials Character Varying( 256 ),
        null, -- prefix_last_name_id -- Bigint NOT NULL,
        'User', --last_name Character Varying( 256 ),
        null, --name_after_last_name_id -- Bigint NOT NULL,
        current_date(), -- birth_date Date NOT NULL,
        NOW() -- created_at Timestamp DEFAULT Now() NOT NULL,
       );
*/

-- select * from votecube.user_account;


insert INTO votecube.themes
values (1,
        'Culture',
        'All topics related to Culture',
        now());
