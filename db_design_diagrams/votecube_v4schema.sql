...
CREATE INDEX "fk_Factors_ParentFactorId" ON "votecube"."factors" USING btree ("parent_factor_id");
-- -------------------------------------------------------------

-- CREATE INDEX "pk_Factors_FactorId" --------------------
CREATE INDEX "pk_Factors_FactorId" ON "votecube"."factors" USING btree ("factor_id" Asc);
-- -------------------------------------------------------------

-- CREATE INDEX "fk_Factors_UserAccountId" ------------------
CREATE INDEX "fk_Factors_UserAccountId" ON "votecube"."factors" USING btree ("user_account_id" Asc);
-- -------------------------------------------------------------

-- CREATE INDEX "ix_Factors_FactorNameId" ----------------
CREATE INDEX "ix_Factors_FactorNameId" ON "votecube"."factors" USING btree ("factor_name" Asc);
-- -------------------------------------------------------------
...
CREATE INDEX "fk_FactorsLinks_FactorId" ON "votecube"."factors_links" USING btree ("factors_id");
-- -------------------------------------------------------------

-- CREATE INDEX "fk_FactorsLinks_LinkId" --------------------
CREATE INDEX "fk_FactorsLinks_LinkId" ON "votecube"."factors_links" USING btree ("links_id");
-- -------------------------------------------------------------

-- CREATE INDEX "fk_FactorsLinks_UserAccountId" -------------
CREATE INDEX "fk_FactorsLinks_UserAccountId" ON "votecube"."factors_links" USING btree ("user_account_id");
-- -------------------------------------------------------------

-- CREATE INDEX "pk_FactorsLinks_FactorLinkId" -----------
CREATE INDEX "pk_FactorsLinks_FactorLinkId" ON "votecube"."factors_links" USING btree ("factors_link_id" Asc);
-- -------------------------------------------------------------
...
CREATE INDEX "fk_Positions_ParentPositionId" ON "votecube"."positions" USING btree ("parent_position_id");
-- -------------------------------------------------------------

-- CREATE INDEX "ix_Positions_PositionDescription" -----------
CREATE INDEX "ix_Positions_PositionDescription" ON "votecube"."positions" USING btree ("position_description");
-- -------------------------------------------------------------

-- CREATE INDEX "fk_Positions_UserAccountId" ------------------
CREATE INDEX "fk_Positions_UserAccountId" ON "votecube"."positions" USING btree ("user_account_id");
-- -------------------------------------------------------------

-- CREATE INDEX "pk_Positions_PositionId" --------------------
CREATE INDEX "pk_Positions_PositionId" ON "votecube"."positions" USING btree ("position_id" Asc);
-- -------------------------------------------------------------
...
CREATE INDEX "fk_FactorPositions_FactorId" ON "votecube"."factor_positions" USING btree ("factor_id");
-- -------------------------------------------------------------

-- CREATE INDEX "fk_FactorPositions_PositionId" -----------
CREATE INDEX "fk_FactorPositions_PositionId" ON "votecube"."factor_positions" USING btree ("position_id");
-- -------------------------------------------------------------

-- CREATE INDEX "pk_FactorPositions_FactorPositionId" --
CREATE INDEX "pk_FactorPositions_FactorPositionId" ON "votecube"."factor_positions" USING btree ("factor_position_id" Asc);
-- -------------------------------------------------------------
...
CREATE INDEX "fk_PollsFactorsPositions_FactorPositionId" ON "votecube"."polls_factors_positions" USING btree ("factor_position_id");
-- -------------------------------------------------------------

-- CREATE INDEX "fk_PollsFactorsPositions_PollId" ----------
CREATE INDEX "fk_PollsFactorsPositions_PollId" ON "votecube"."polls_factors_positions" USING btree ("poll_id");
-- -------------------------------------------------------------

-- CREATE INDEX "pk_PollsFactorsPositions_PollFactorPositionId"
CREATE INDEX "pk_PollsFactorsPositions_PollFactorPositionId" ON "votecube"."polls_factors_positions" USING btree ("poll_factor_position_id" Asc);
-- -------------------------------------------------------------
...
CREATE INDEX "fk_Town_StateId" ON "votecube"."town" USING btree ("state_id" Asc);
-- -------------------------------------------------------------
...
--drop sequence "votecube"."position_id";
...
values (1, --"user_account_id" Bigint NOT NULL,
        ...
        NOW() -- "created_at" Timestamp With Time Zone DEFAULT Now() NOT NULL,
       );
