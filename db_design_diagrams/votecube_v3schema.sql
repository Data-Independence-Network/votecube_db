...
-- CREATE INDEX "fk_Polls_TownId" ------------------------------
CREATE INDEX "fk_Polls_TownId" ON "votecube"."polls" USING btree( "town_id" );
-- -------------------------------------------------------------
...
-- CREATE LINK "fk_Polls_Town_TownId" --------------------------
ALTER TABLE "votecube"."polls"
	ADD CONSTRAINT "fk_Polls_Town_TownId" FOREIGN KEY ( "town_id" )
